...
### Code Analysis Report ([Report Summary](./target/report/camila-services/staging/index.html))
...
export MAVEN_GPG_PASSPHRASE="${MAVEN_GPG_PASSPHRASE:-"password"}"
# Verify project
mvn -B install site -P error-prone,quality-check | tee mvn-build-$(date +%Y%m%d-%H%M%S).log
# Consolidate reports
