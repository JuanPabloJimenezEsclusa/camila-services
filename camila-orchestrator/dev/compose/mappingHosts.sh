...
source_str='127.0.0.1  admin  config  discovery  gateway  prometheus  grafana  zipkin  keycloak  mongodb  couchbase  compose-backend-product-1  compose-backend-product-2  elasticsearch  kibana  fluentd'
