...
```bash
mvn clean test \
  -Dtest=com.camila.api.behaviour.ProductBehaviourRunner \
  --file camila-product-api/camila-product-api-infrastructure/driving/camila-product-api-infrastructure-boot/pom.xml
```
