...
@OpenAPIDefinition(
  ...
  info = @Info(title = "Camila Product API",
    description = "API Rest in Camila Product project",
    contact = @Contact(name = "Juan Pablo Jimenez Esclusa", email = "juan.pablo.jimenez.esclusa@gmail.com"),
    summary = "Camila Product API",
    version = "1.0.0",
    license = @License(name = "GPL-3.0", url = "https://github.com/JuanPabloJimenezEsclusa/camila-services/blob/main/LICENSE.md")),
  externalDocs = @ExternalDocumentation(description = "Camila Service Documentation",
