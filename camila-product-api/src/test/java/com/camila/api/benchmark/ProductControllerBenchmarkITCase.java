...
@DisplayName("[JMH-T][ProductControllerBenchmarkITCase] Java benchmark tests")
@SuppressWarnings({"java:S5786"}) // JMH requires public test class
public class ProductControllerBenchmarkITCase {
  ...
  void setWebTestClient(WebTestClient webClient) {
    ProductControllerBenchmarkITCase.webClient = webClient;
  }

  @Test
  @DisplayName("[ProductControllerBenchmarkITCase] Run benchmark")
