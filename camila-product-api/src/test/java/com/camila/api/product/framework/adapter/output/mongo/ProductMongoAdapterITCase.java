...
/**
 * The type Product mongo adapter it case.
 */
@EnableAutoConfiguration
@DataMongoTest()
@ExtendWith(SpringExtension.class)
@EntityScan(basePackages = "com.camila.api.product.framework.adapter.output.mongo")
@ComponentScan(basePackages = "com.camila.api.product.framework.adapter.output.mongo")
...
class ProductMongoAdapterITCase {
   ...
   */
  @Test
  @DisplayName("[ProductMongoAdapter] findByInternalId ok")
   ...
   */
  @Test
  @DisplayName("[ProductMongoAdapter] sort with more stock weight")
   ...
   */
  @Test
  @DisplayName("[ProductMongoAdapter] sort with more sales units weight")
   ...
   */
  @Test
  @DisplayName("[ProductMongoAdapter] sort with default metric and pagination")
