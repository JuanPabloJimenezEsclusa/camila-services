...
/*
 * Slicing spring configuration. Benefits: - Faster test execution: Only loads
 * necessary components - Improved test isolation: Focus on specific
 * layers/components - Greater control: Clear definition of test boundaries -
...
@ImportAutoConfiguration(exclude = {
		...
		WebClientAutoConfiguration.class, ReactiveOAuth2ClientAutoConfiguration.class,
