...
public abstract class MongoContainerConfig {
	...
	private static final String PRODUCTS_JSON = Objects
			.requireNonNull(MongoContainerConfig.class.getClassLoader().getResource("scripts/mongo/products.json"))
			.getPath();
	...
	private static void initDatabase() {
		try (final var mongoClient = com.mongodb.client.MongoClients.create(container.getConnectionString())) {
